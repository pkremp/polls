...
knitr::kable(last_polls, col.names = c("Date (Midpoint)", "Source", "State", "% Clinton", "% Trump", "N"))
```
...
Each national poll is represented as a dot (darker dots indicate narrower margins of error). 
...
I restrict each poll's sample to respondents declaring vote intentions for Clinton or Trump, so that $N = N^{clinton} + N^{trump}$. (This is problematic for Utah, where Evan McMullin could win).
