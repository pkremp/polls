...
The `runmodel.R` script downloads state and national polls from the [HuffPost Pollster website](http://http://elections.huffingtonpost.com/pollster) as `.csv` files before processing the data.
