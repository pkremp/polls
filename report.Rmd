...
New: [What is the probability that your vote will decide the election?](http://rawgit.com/pkremp/polls/master/pr_decisive_vote.html) (with Andrew Gelman). R code available [here](https://github.com/pkremp/polls/blob/master/pr_decisive_vote.R).

New: [Updating the Forecast on Election Night with R](http://rawgit.com/pkremp/polls/master/update_prob.html). R code available [here](https://github.com/pkremp/polls/blob/master/update_prob.R).
