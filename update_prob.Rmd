---
title: Updating the Forecast on Election Night
...
I wrote a very simple function in R, `update_prob()`, that does just that. It takes as input a set of events that you want to condition on (e.g. Clinton or Trump already won a set of states; or the two-way final score in a given state falls within a certain interval), and it displays out the updated forecast by drawing from the conditional distribution. 
